    ...
    <main style={{width: "100vw", height: "50rem", padding: "1.2rem", display: "flex", gap: "1rem", flexDirection: "row"}}>
        <section className="left-container" style={{width: "30%"}}>
                ...
                <div
                    ...
                    >
                      <div>
                        <h1 className="text-[2em] font-medium">Estadistica</h1>
                        <p className="text-[0.85em]">
                          Proximamente ver dashboard personalizada con datos estadisticos de las ultimas solicitudes y actividades
                        </p>
                      </div>
